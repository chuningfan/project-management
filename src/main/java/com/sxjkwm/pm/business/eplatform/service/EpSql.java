...
public class EpSql {
    ...
    static String invoicePrintingSql = "SELECT DISTINCT o.supplier_org_id, o.supplier_name, o.buyer_name, o.order_time, o.buyer_org_name, o.buyer_org_full_name, o.sale_order_no, o.final_price, bi.bill_code, bi.bill_price, ia.apply_number, " +
